      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
          <div className="lg:col-span-2 animate-on-scroll opacity-0 transition-all duration-700" style={{ animationDelay: '200ms' }}>
            <div className="relative w-64 h-64 mx-auto rounded-full overflow-hidden shadow-lg transform hover:scale-105 hover:rotate-3 transition-all duration-700 border-4 border-[#00A1E0]">
              <img 
                ...
                onError={(e) => {
                  ...
                  target.parentElement!.innerHTML = '<div class="w-full h-full flex items-center justify-center bg-gradient-to-r from-[#00A1E0] to-[#6452E9] text-white text-4xl font-bold animate-gradient-background">WA</div>';
                }}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#00A1E0]/70 to-transparent opacity-30 hover:opacity-0 transition-opacity duration-500"></div>
            </div>
            
            {/* Name */}
            <h3 className="text-2xl font-bold text-center text-salesforce-navy dark:text-white mt-4 mb-2 animate-on-scroll opacity-0 transition-all duration-700 delay-[300ms]">
              Wasim Ansari
            </h3>
            <p className="text-center text-gray-600 dark:text-gray-400 text-lg mb-6 animate-on-scroll opacity-0 transition-all duration-700 delay-[400ms]">Salesforce Developer</p>
            
            {/* Social Links */}
            <div className="w-full max-w-sm mx-auto animate-on-scroll opacity-0 transition-all duration-700" style={{ animationDelay: '500ms' }}>
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 shadow-sm transform transition-all duration-500 hover:shadow-lg hover:-translate-y-1">
                <div className="space-y-3">
                  <a 
                    href="tel:+917044133855" 
                    className="flex items-center py-1 text-gray-700 dark:text-gray-300 hover:text-[#00A1E0] dark:hover:text-[#00A1E0] transition-colors"
                  >
                    <div className="w-8 h-8 rounded-full bg-[#00A1E0]/10 flex items-center justify-center mr-3 flex-shrink-0">
                      <svg className="h-4 w-4 text-[#00A1E0]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  >
                    <div className="w-8 h-8 rounded-full bg-[#00A1E0]/10 flex items-center justify-center mr-3 flex-shrink-0">
                      <svg className="h-4 w-4 text-[#00A1E0]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-3 animate-on-scroll opacity-0 transition-all duration-700" style={{ animationDelay: '400ms' }}>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed animate-on-scroll opacity-0 transition-all duration-700" style={{ animationDelay: '600ms' }}>
            ...
            <div className="flex flex-wrap gap-4 animate-on-scroll opacity-0 transition-all duration-700" style={{ animationDelay: '700ms' }}>
              <a 
                href="#projects" 
                className="inline-flex items-center px-5 py-2.5 bg-[#00A1E0] text-white font-medium rounded-lg transition-colors hover:bg-[#0080b3]"
              >
                View My Work
              ...
              <a 
                ...
                className="inline-flex items-center px-5 py-2.5 text-[#00A1E0] border border-[#00A1E0] font-medium rounded-lg hover:bg-[#00A1E0] hover:text-white transition-colors"
              >
                Resume
                <svg className="ml-2 -mr-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
